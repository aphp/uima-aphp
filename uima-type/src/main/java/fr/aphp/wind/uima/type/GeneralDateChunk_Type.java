 ...
 * @generated */
public class GeneralDateChunk_Type extends Chunk_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (GeneralDateChunk_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = GeneralDateChunk_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new GeneralDateChunk(addr, GeneralDateChunk_Type.this);
  			   GeneralDateChunk_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new GeneralDateChunk(addr, GeneralDateChunk_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = GeneralDateChunk.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.aphp.wind.uima.type.GeneralDateChunk");
  ...
  public String getChunkValue(int addr) {
      ...
      jcas.throwFeatMissing("chunkValue", "fr.aphp.wind.uima.type.GeneralDateChunk");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public GeneralDateChunk_Type(JCas jcas, Type casType) {
    super(jcas, casType);
