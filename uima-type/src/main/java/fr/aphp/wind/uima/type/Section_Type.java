...
public class Section_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.type.Section");
  ...
  public int getIds_ref_section(int addr) {
      ...
      jcas.throwFeatMissing("ids_ref_section", "org.apache.uima.type.Section");
  ...
  public String getSection_label(int addr) {
      ...
      jcas.throwFeatMissing("section_label", "org.apache.uima.type.Section");
