 ...
 * @generated */
public class GeneralCityChunk_Type extends Chunk_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (GeneralCityChunk_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = GeneralCityChunk_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new GeneralCityChunk(addr, GeneralCityChunk_Type.this);
  			   GeneralCityChunk_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new GeneralCityChunk(addr, GeneralCityChunk_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = GeneralCityChunk.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.aphp.wind.uima.type.GeneralCityChunk");
  ...
  public String getChunkValue(int addr) {
      ...
      jcas.throwFeatMissing("chunkValue", "fr.aphp.wind.uima.type.GeneralCityChunk");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public GeneralCityChunk_Type(JCas jcas, Type casType) {
    super(jcas, casType);
