 ...
 * @generated */
public class GeneralNbNdaChunk_Type extends Chunk_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (GeneralNbNdaChunk_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = GeneralNbNdaChunk_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new GeneralNbNdaChunk(addr, GeneralNbNdaChunk_Type.this);
  			   GeneralNbNdaChunk_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new GeneralNbNdaChunk(addr, GeneralNbNdaChunk_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = GeneralNbNdaChunk.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.aphp.wind.uima.type.GeneralNbNdaChunk");
  ...
  public String getChunkValue(int addr) {
      ...
      jcas.throwFeatMissing("chunkValue", "fr.aphp.wind.uima.type.GeneralNbNdaChunk");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public GeneralNbNdaChunk_Type(JCas jcas, Type casType) {
    super(jcas, casType);
