 ...
 * @generated */
public class NoteHeaderChunk_Type extends Chunk_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = NoteHeaderChunk.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.type.NoteHeaderChunk");
  ...
  public String getChunkValue(int addr) {
      ...
      jcas.throwFeatMissing("chunkValue", "org.apache.uima.type.NoteHeaderChunk");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public NoteHeaderChunk_Type(JCas jcas, Type casType) {
    super(jcas, casType);
