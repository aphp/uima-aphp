 ...
 * @generated */
public class GeneralNbIppChunk_Type extends Chunk_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (GeneralNbIppChunk_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = GeneralNbIppChunk_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new GeneralNbIppChunk(addr, GeneralNbIppChunk_Type.this);
  			   GeneralNbIppChunk_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new GeneralNbIppChunk(addr, GeneralNbIppChunk_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = GeneralNbIppChunk.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.aphp.wind.uima.type.GeneralNbIppChunk");
  ...
  public String getChunkValue(int addr) {
      ...
      jcas.throwFeatMissing("chunkValue", "fr.aphp.wind.uima.type.GeneralNbIppChunk");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public GeneralNbIppChunk_Type(JCas jcas, Type casType) {
    super(jcas, casType);
