...
public class HashMapDictionaryBuilder implements DictionaryBuilder {
  ...
  private boolean accentNormalization;
   ...
   * 
   * @see
   * org.apache.uima.annotator.dict_annot.dictionary.DictionaryBuilder#setDictionaryProperties(java.
   * lang.String, java.lang.String, boolean, boolean, java.lang.String)
   */
  ...
  /**
   * split up the given input in several tokens using the multi-word separator character as
   * delimiter.
   * 
   ...
   * 
   * @see
   * org.apache.uima.annotator.dict_annot.dictionary.DictionaryBuilder#addWord(java.lang.String)
   */
